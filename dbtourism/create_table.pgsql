...
insert into "Client"("Contact_details","Full_name","Date_of_registration") values
('38066405077 Thelolownedlol@gmail.com','Харитонов Микола Костянтинович','2018-02-04'),
 ('380995505249 dota2zelendoren@gmail.com','Адаменко Павел Юрьевич','2016-05-20'),
('380965870700 boyvlad99@gmail.com','Бойченко Владислав Сергеевич','2020-05-01'),
('380668906427 vadym1504@gmail.com ','Велев Вадим Олегович','2020-05-06'),
('380975533177 ddd.tosha@gmail.com','Гейко Антон Сергеевич','2020-05-05'),
('380965872712 boyViktor@gmail.com','Дмитриев Виктор Олегович','2020-05-07'),
('380965855555 boyLalyd@gmail.com','Лалуд Эдуард Витальевич','2020-05-10'),
('380934953674 iidarkii@ukr.net','Малеев Максим Васильевич','2020-05-11'),
('380965888700 boyDmitro@gmail.com','Осиков Дмитрий Вадимович','2020-05-15'),
('380681818911 doqsoftware@gmail.com','Педаш Юрий Юрьевич','2020-05-12');       
...
('Харитонова Дарья Олеговна','Менеджер','2016-02-20',NULL,5500,3,'1992-08-25','Код подразделения 507-474 Дата выдачи 25.04.2010','Работает',NULL),
 ...
 ('Черный Ярослав Олегович','Водитель','2017-04-20',NULL,5500,5,'1981-09-20','Код подразделения 305-304 Дата выдачи 15.05.1999','Работает',NULL),
 ('Берков Александр Алексеевич','Экскурсовод','2018-09-25',NULL,5800,6,'1980-11-20','Код подразделения 305-404 Дата выдачи 15.12.2008','Работает',NULL),
 ('Лалуд Максим Олегович','Экскурсовод','2018-01-20',NULL,6000,7,'1981-06-19','Код подразделения 300-403 Дата выдачи 15.08.1999','Работает',NULL),
 ('Олейник Константин Евегневич','Водитель','2018-04-20',NULL,5600,8,'1983-09-20','Код подразделения 305-332 Дата выдачи 15.05.2001','Работает',NULL),
 ('Свещевский Кирил Евгеневич','Водитель','2017-04-15',NULL,5450,9,'1983-03-20','Код подразделения 305-322 Дата выдачи 19.03.2001','Работает',NULL),
 ('Кравчук Данил Олегович','Экскурсовод','2016-01-20',NULL,5700,10,'1981-03-19','Код подразделения 322-403 Дата выдачи 15.03.1999','Работает',NULL),
 ('Харрингтон Морис Васильев','Экскурсовод','2017-06-20',NULL,6200,11,'1981-07-19','Код подразделения 233-403 Дата выдачи 15.07.1999','Работает',NULL);
